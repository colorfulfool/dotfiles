...
hl.bind("SUPER + ALT + H", hl.dsp.window.resize({ x = 100, y = 0 }))
hl.bind("SUPER + ALT + L", hl.dsp.window.resize({ x = -100, y = 0 }))
hl.bind("SUPER + ALT + K", hl.dsp.window.resize({ x = 0, y = -100 }))
hl.bind("SUPER + ALT + J", hl.dsp.window.resize({ x = 0, y = 100 }))
